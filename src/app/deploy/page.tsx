...
import { ArrowBigLeft, ArrowBigRightDash, BadgeRussianRuble, Github,Waves } from "lucide-react";
  ...
  return (
    ...
    <main className="flex justify-center items-center h-[100vh]">
      ...
      <div className="w-[600px]">
        ...
        {logs.length > 0 && (
          <div
            className={`${firaCode.className} text-sm text-green-500 logs-container mt-5   rounded-lg p-4 h-[300px] overflow-y-auto`}
          >
